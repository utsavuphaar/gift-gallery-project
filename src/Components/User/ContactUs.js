                                          ...
                                          <section class="box-2 ml-5 mt-sm-4">
                                                <div class="row fill-margin">
                                                      <div class="col-lg-4 form-floating">
                                                            <form action="" className="form-class">
                                                                  <div class="input-field">
                                                                        <input type="text" id="name" required className="input-tag" />
                                                      ...
                                                      <div class="form-group">
                                                            <textarea id="message" class="form-field mt-5 your-message-text-area" placeholder="Your Message" rows="6" required></textarea>
