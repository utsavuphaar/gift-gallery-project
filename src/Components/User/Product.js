...
function Product() {
    ...
    return <>
        ...
        {productList.length == 0 ? (
            ...
            <div className="row p-0 mb-3 position-sticky" style={{ top: '10' }}>
                <div className="col-lg-3 p-0 position-sticky" style={{ top: '130px' }}>
                    <div style={{ position: "sticky", top: "130px" }}>
                        <Accordion style={{ backgroundColor: "", boxShadow: "none", border: "none" }} defaultExpanded>
                            ...
                            {brand.map((item, index) => (
                                <AccordionDetails className='ms-5' key={index}>
                                    <Typography>
                                        <input className="form-check-input ms-3" type="checkbox" onClick={() => getproductbybrand(item, index)} id={`flexCheckDefault${index}`} />
                                        <label className="form-check-label ms-3" htmlFor={`flexCheckDefault${index}`}>
                                            {item}
                                        </label>
                                    </Typography>
                                </AccordionDetails>
                        ...
                        <Accordion style={{ backgroundColor: "", boxShadow: "none", border: "none" }} defaultExpanded>
                            ...
                            {[5, 4, 3, 2].map((rating) => (
                                <AccordionDetails className='ms-5' key={rating}>
                                    <Typography>
                                        <input className="form-check-input ms-3" type="checkbox" onClick={() => getproductbyrating(rating)} id={`CheckDefault${rating}`} />
                                        <label className="form-check-label ms-3" htmlFor={`CheckDefault${rating}`}>
                                            {[...Array(5)].map((_, i) => (
                                                <ImStarFull key={i} className={i < rating ? 'text-warning' : 'text-secondary'} />
                                            ))}
                                        </label>
                                    </Typography>
                                </AccordionDetails>
                ...
                <div className="col-lg-9 p-0 d-flex flex-wrap justify-content-around align-items-start">
                    {productList.map((product, index) => (
                        <div className="mt-2 col-lg-4 d-flex justify-content-center align-items-center" key={index}>
                            <div style={{ width: "300px", borderRadius: "10px" }} className="bg-white p-2 m-2 d-flex flex-column align-items-center">
                                <img src={product.thumbnail} className='gift-image' style={{ width: "270px", height: "230px", borderRadius: "10px" }} alt={product.title} />
                                ...
                                <div className="w-100 d-flex justify-content-between align-items-center">
                                    <div className="d-flex align-items-center justify-content-around ms-2">
                                        <h5 style={{ fontSize: "15px" }}>₹ {(product.price - (product.price * product.discountPercentage / 100)).toFixed(2)}</h5>
                                ...
                                <div className="w-100 mt-2 d-flex justify-content-around align-items-center mb-1">
                                    <div className="movetocart" onClick={() => addToCart(product.id)}>
                                        <div className="movetocart-wrapper">
                                            <div className="text-1">Move to cart</div>
