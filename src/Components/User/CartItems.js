    ...
    return <>
        ...
        {cartItems.length != 0 ? (
            <section id="main-cart" >
                <div id="cart-left">
                    {cartItems?.map((cart, index) => <div key={index} className="m-2 p-4 d-flex border" style={{ width: '100%', backgroundColor: 'white', height: 'auto' }}>
                        ...
                        <div className="ms-2" style={{ width: '70%', height: 'auto' }}>
                            ...
                            <div className="p-1">
                                <button onClick={() => removeItemFromCart(index, cart["products.id"])} className="btn btn-outline-danger">Remove</button>
                                &nbsp;&nbsp;<button className="btn btn-outline-primary">Save For Later</button>
                            </div>
                        </div>
                    ...
                    <div className="d-flex justify-content-between p-4 border ms-2 bg-white">
                        <Link to="/">
                    ...
                    <div className="p-2 ms-2 d-flex justify-content-around ">
                ...
                <div id="cart-right">
                    <div className="border" id="cart-right-child1">
                        ...
                        <center>
                            <button className="btn btn-success" style={{ width: '90%' }}>Checkout</button>
                        </center>
                    </div>
                </div>
            </section>
